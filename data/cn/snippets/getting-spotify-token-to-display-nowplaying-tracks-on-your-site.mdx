...
type: 'Spotify'
draft: false
summary: 'How to get Spotify token and use it to display now playing track on your website'
...
```bash
https://accounts.spotify.com/authorize?client_id=d454509dae784555a49b2bcc72d325ee&response_type=code&redirect_uri=http://localhost:3434&scope=user-read-currently-playing
```
